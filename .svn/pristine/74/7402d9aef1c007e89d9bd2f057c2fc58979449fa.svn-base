	...
	public function load_frontend_scripts() {
		...
		*/
		...
		if ( true === $font_awesome /* or !isset( $font_awesome ) */ ) {
			wp_enqueue_style( 'font-awesome', $this->plugin_url . '/assets/font-awesome/css/font-awesome.min.css', null, '4.7.0' );
		...
		wp_enqueue_style( 'bootstrap' . $rtl, $this->plugin_url . '/assets/bootstrap' . $rtl . '/css/bootstrap' . $rtl_ext . '.min.css', null, '3.3.7' );
		wp_enqueue_script( 'bootstrap', $this->plugin_url . '/assets/bootstrap/js/bootstrap.min.js', array(), '3.3.7', true );
	}
		...
		*/
		...
		add_editor_style(
			array(
				...
				$this->plugin_url . '/assets/bootstrap' . $rtl . '/css/bootstrap' . $rtl_ext . '.min.css',
			)
		);
	}
