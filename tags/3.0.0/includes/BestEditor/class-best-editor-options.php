<?php
/**
 * Best Editor Settings Page Class
 * 
 * @package Best_Editor
 */
...
final class Best_Editor_Options extends \DediData\Singleton {
	...
	public function __construct( $plugin_slug = null ) {
		...
		$this->page_title  = esc_html__( 'Best Editor', 'best-editor' );
		$this->menu_title  = esc_html__( 'Best Editor', 'best-editor' );
	...
	public function on_plugin_page_load() {
		...
		$help_content = '<p>' . esc_html__( 'Use this page to configure Best Editor plugin', 'best-editor' ) . '</p>';
	...
	public function add_admin_notices() {
		...
		<div id="notice" class="update-nag">
			<?php esc_html_e( 'Best Editor plugin is not configured', 'best-editor' ); ?>
	...
	public function settings_page_content() {
		...
		<div class="wrap">
			...
			<form method="post" action="options.php">
				...
				<p><?php esc_html_e( 'Best Editor automatically loads FontAwesome and Bootstrap 3.3.7 in editor area, But if you like to use Font Awesome and Bootstrap elements', 'best-editor' ); ?></p>
				<p><?php esc_html_e( 'You should load these libraries in your site frontend, you can enable them in following (if your theme doesn\'t load these libraries)', 'best-editor' ); ?></p>
			<?php
				submit_button();
